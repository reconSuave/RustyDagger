...
public class arRanking extends Screen {
    ...
    static final String[][] stats = {new String[]{Constants.FAME, "Place", Constants.CLAN}, new String[]{Constants.SKILL, "At/Df", "Stats"}, new String[]{Constants.RANK, Constants.AGE, ""}, new String[]{"Cash", Constants.GUILD, ""}, new String[]{"Men", "Power", "Leader"}};
    static final Color[] clear = {new Color(255, 128, 128), new Color(0, 224, 224), new Color(255, 0, 255), new Color(0, 255, 0), new Color(255, 128, 128)};
    static final Color[] bars = {new Color(255, 160, 160), new Color(128, 255, 255), new Color(255, 128, 255), new Color(160, 255, 160), new Color(255, 160, 160)};
        ...
        while (e.hasMoreElements() && i3 <= 12) {
            ...
            if (it instanceof itList) {
                ...
                if (this.which == 4) {
                    ...
                    next = 0 + 1;
                    g.drawString(String.valueOf(String.valueOf(Constants.rankTitle[list.select(next).toInteger()])).concat(String.valueOf(String.valueOf(list.getName()))), h + 6, v);
                }
                g.setFont(Tools.textF);
                int h2 = SHOWLEFT;
                while (true) {
