...
public class arBuild extends Screen implements GameStrings {
    ...
    static final Rectangle[] trect = {new Rectangle(70, 103, 100, 22), new Rectangle(70, 133, 100, 22), new Rectangle(70, 163, 100, 22), new Rectangle(260, 103, 100, 22), new Rectangle(260, 133, 100, 22), new Rectangle(260, 163, 100, 22), new Rectangle(170, 193, 225, 22), new Rectangle(170, 219, 225, 22), new Rectangle(170, 245, 225, 22)};
    ...
    public void localPaint(Graphics g) {
        ...
        g.drawString("Description of ".concat(String.valueOf(String.valueOf(String.valueOf(String.valueOf(new StringBuffer(String.valueOf(String.valueOf(Constants.rankName[this.gender][h.getSocial()]))).append(" ").append(h.getName())))))), 5, 15);
