...
public class arClanHall extends Indoors implements Constants {
    ...
    static final String leaveClan = "\tIt is with bitter regret (and an empty purse) that you turn your back on the men who have been your comrades since adolescence.\n\n\t*** STATUS = CLANLESS ***\n";
    static final String petitionMsg = "$TB$Your petition has been sent to $leader$, current leader of the $clan$ clan.  He will need time to consider your plea, and will hopefully respond by sending you a Grant to Join.";
    static final String denyHead = "You draft the following missive:\n\n";
    static final String denyMsg = "$today$\n\tMy Dear $name$\n\tHaving duly considered your proposal, I have come to the conclusion that you are not currently a suitable candidate for the $clan$ Clan.\n\tThere is nodoby else.  It's not you, it's us. Let's just be good friends.\n\tSincerely,\n\t$leader$";
    static final String createMsg = "$TB$You labor tirelessly for the inauguration. You find a celebration hall and send out hundreds of invitations.  You hire musicians, actors, jugglers, magicians, and Moorish dancers.  You employ Orcish bouncers, Elvin chefs, Human waiters,  and Dwarven janitors.$CR$$TB$Finally, the great day comes.  Nobles from accross the kingdom are in attendance when $ruler$ makes the grand announcement: $TB$\"On This Day, Clan $clan$ is Born!\"$CR$";
    ...
    static final String grantMsg = "\tYou compose an elegant message accepting $name$'s petition.  The hero will recieve your message upon the morrow, and should merge with the $clan$ Clan soon after.";
    static final String reinstateMsg = "$TB$Servile Krymp pales with horror!$CR$$TB$\"Your Lordship,\" he whimpers, \"There has been a terrible mistake.\"  He cowers before you and cringes from your every move. \"We will rectify this error instantly.  Please don't tell $ruler$.$CR$$CR$$TB$$leader$ has been reinstated as leader of Clan $clan$.";
