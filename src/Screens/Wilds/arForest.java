...
public class arForest extends WildsScreen {
    ...
    Screen hills() {
        ...
        String msg = String.valueOf(String.valueOf(String.valueOf(String.valueOf(new StringBuffer("\tYou march along a rising trail, admiring the spreading vista where mountain meets forest.\n\n\t").append(this.hills[Tools.roll(this.fields.length)]).append("\n\n\tYou Enter the Mountains...\n"))))).concat(String.valueOf(String.valueOf(h.gainWits(3))));
        h.travelWork(1);
