...
public class arStorage extends Transfer {
    ...
    public void localPaint(Graphics g) {
        ...
        g.drawString(String.valueOf(String.valueOf(new StringBuffer("Backpack ").append(Screen.getPack().getCount()).append("/").append(Screen.getHero().packMax()))), 30, 65);
        g.drawString(String.valueOf(String.valueOf(new StringBuffer("Storage ").append(stashCount()).append("/").append(getLimit()))), 230, 65);
    }
}
