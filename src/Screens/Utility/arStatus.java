...
public class arStatus extends Screen implements GearTypes, ArmsTrait {
    ...
    static final String[] slot = {ArmsTrait.HEAD, ArmsTrait.BODY, ArmsTrait.FEET, ArmsTrait.RIGHT, ArmsTrait.LEFT};
    ...
    void updateTools() {
        ...
        this.action[0].setLabel(String.valueOf(String.valueOf(useString())).concat(String.valueOf(String.valueOf(this.fight ? String.valueOf(String.valueOf(new StringBuffer(" (").append(h.actions()).append(")"))) : ""))));
    ...
    String nameItem(Item it) {
        return !GearTable.canMageUse(it) ? it.toShow() : String.valueOf(String.valueOf(new StringBuffer(String.valueOf(String.valueOf(it.toShow()))).append("{").append(GearTable.effectLabel(it)).append("}")));
    }
    ...
    void drawStats(Graphics g) {
        ...
        g.drawString(String.valueOf(String.valueOf(h.getTitle())).concat(String.valueOf(String.valueOf(h.getName()))), 5, 18);
        g.drawString(String.valueOf(String.valueOf(new StringBuffer("Level: ").append(h.getLevel()).append("   Rank: ").append(h.getRankTitle()).append("   Age: ").append(h.getAge()))), 5, 36);
        g.drawString(String.valueOf(String.valueOf(new StringBuffer("Guts: ").append(h.getGuts()).append(wounds > 0 ? String.valueOf(String.valueOf(new StringBuffer("[-").append(wounds).append("]"))) : ""))), 5, 54);
        ...
        g.drawString(String.valueOf(String.valueOf(new StringBuffer("Quests: ").append(h.getBaseQuests()).append(fatigue > 0 ? String.valueOf(String.valueOf(new StringBuffer("[-").append(fatigue).append("]"))) : ""))), 5, 108);
        ...
        g.drawString(String.valueOf(String.valueOf(new StringBuffer("Skill: ").append(h.getSkill()).append(disease > 0 ? String.valueOf(String.valueOf(new StringBuffer("[-").append(disease).append("]sick"))) : ""))), 140, 90);
        ...
        String msg = String.valueOf(String.valueOf(new StringBuffer("Load: ").append(Screen.getPack().getCount()).append(" (").append(h.packMax()).append(")")));
    ...
    void drawGear(Graphics g, int dx, int dy) {
        ...
        for (int ix = 0; ix < 5; ix++) {
            ...
            dy += 20;
            g.drawString(String.valueOf(String.valueOf(loc[ix])).concat(String.valueOf(String.valueOf(it == null ? "" : it.toShow()))), dx, dy);
        }
    }
    ...
    String actionLine(itAgent h) {
        ...
        String msg = "";
        while (e.hasMoreElements()) {
            msg = String.valueOf(String.valueOf(msg)).concat(String.valueOf(String.valueOf(" ".concat(String.valueOf(String.valueOf(((Item) e.nextElement()).toShow()))))));
        }
    ...
    String guildLine(itAgent h) {
        ...
        int num = h.fightRank();
        if (num > 0) {
            msg = String.valueOf(String.valueOf(msg)).concat(String.valueOf(String.valueOf(String.valueOf(String.valueOf(new StringBuffer("F:").append(h.fight()).append("/").append(num).append("  "))))));
        }
        int num2 = h.magicRank();
        if (num2 > 0) {
            msg = String.valueOf(String.valueOf(msg)).concat(String.valueOf(String.valueOf(String.valueOf(String.valueOf(new StringBuffer("M:").append(h.magic()).append("/").append(num2).append("  "))))));
        }
        int num3 = h.thiefRank();
        if (num3 > 0) {
            msg = String.valueOf(String.valueOf(msg)).concat(String.valueOf(String.valueOf(String.valueOf(String.valueOf(new StringBuffer("T:").append(h.thief()).append("/").append(num3).append("  "))))));
        }
        int num4 = h.ieatsuRank();
        if (num4 > 0) {
            msg = String.valueOf(String.valueOf(msg)).concat(String.valueOf(String.valueOf(String.valueOf(String.valueOf(new StringBuffer("S:").append(h.ieatsu()).append("/").append(num4).append("  "))))));
        }
        return msg;
    }

    public boolean mouseMove(Event e, int x, int y) {
        Item what = !gearRect.inside(x, y) ? null : Screen.getHero().findGearTrait(slot[(y - gearRect.y) / 20]);
        if (what == this.over) {
            return false;
        }
    ...
    void dumpItem() {
        if (this.pick != null) {
            ...
            } else if (Screen.getGear().indexOf(this.pick) >= 0 && (this.pick instanceof itArms) && !((itArms) this.pick).hasTrait(ArmsTrait.CURSE) && Screen.getGear().drop(this.pick) != null) {
                getDump().insert(this.pick);
                this.pick = null;
            }
        }
    ...
    boolean removeGear(itArms what) {
        ...
        if (what.isCursed()) {
            Tools.setRegion(new arNotice(this, String.valueOf(String.valueOf(new StringBuffer("\tYou can't remove the ").append(what.getName()).append("!  The @&$#~ thing is Cursed %#$@!\n")))));
            return false;
        }
    ...
    void effectFaceless() {
        ...
        Tools.setRegion(new arNotice(new arPeer(this, 2, Screen.getHero().getName()), "\tYou feel your features dissolve into an indistinct and shapeless form."));
    }
    ...
    boolean tryScroll(itArms what) {
        ...
        Tools.setRegion(new arNotice(this, String.valueOf(String.valueOf(new StringBuffer("\tThe mass and material of the ").append(what.getName()).append(" resists the power of your spell.  This scroll has been ").append("inneffective.\n")))));
        return false;
    }
    ...
    void effectBless(itArms what) {
        if (tryScroll(what)) {
            if (what.isCursed()) {
                ...
                Tools.setRegion(new arNotice(this, String.valueOf(String.valueOf(new StringBuffer("\tThe ").append(what.getName()).append(" flashes and sparkles first red ").append("then blue as a terrible curse is lifted...\n")))));
                return;
            }
    ...
    void effectEnchant(itArms what) {
        if (tryScroll(what)) {
            ...
            if (dif < 0) {
                ...
                Tools.setRegion(new arNotice(new arDetail(this, what), String.valueOf(String.valueOf(new StringBuffer("\tThe ").append(what.getName()).append(" pulses with a dangerous purple light.")))));
            } else {
                if (Screen.getGear().drop(what) == null) {
                    removePack(what);
                }
                String msg = String.valueOf(String.valueOf(new StringBuffer("\tThere is a hot, steamy explosion as your ").append(what.getName()).append(" suddenly disintegrates into whirling, melting, whining ").append("and floating fragments!  The magical energies penetrate ").append("your body causing -").append(dif).append(" wounds!\n")));
                Screen.getHero().addWounds(dif);
                if (Screen.getHero().isDead()) {
                    Tools.setRegion(Screen.getHero().killedScreen(getHome(), String.valueOf(String.valueOf(msg)).concat("\n\tYou have been killed!\n"), false));
                } else {
