...
public class FScrollbar extends FTools {
    ...
    public void setVal(int newVal) {
        ...
        if (this.horz) {
            this.thumb.x = this.head.x + this.head.width + (this.iMax < 1 ? 0 : (this.iVal * ((r.width - (2 * this.head.width)) - this.thumb.width)) / this.iMax);
        } else {
            this.thumb.y = this.head.y + this.head.height + (this.iMax < 1 ? 0 : (this.iVal * ((r.height - (2 * this.head.height)) - this.thumb.height)) / this.iMax);
        }
    }
