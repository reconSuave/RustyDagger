  ...
  public void paint(Graphics g) {
    ...
    if (hp != null) {
      ...
      g.drawString(
          String.valueOf(
              String.valueOf(
                  new StringBuffer(String.valueOf(String.valueOf(hp.getTitle())))
                      .append(hp.getName())
                      .append("  Guts:")
                      .append(hp.getGuts() - w)
                      .append(w < 1 ? "" : "/".concat(String.valueOf(String.valueOf(hp.getGuts()))))
                      .append(" Wits:")
                      .append(hp.getWits())
                      .append(" Charm:")
                      .append(hp.getCharm())
              ...
              it != null
                  ? String.valueOf(String.valueOf(msg2))
                      .concat(
                          String.valueOf(
                              String.valueOf(
                                  "glowing ".concat(String.valueOf(String.valueOf(it.getName()))))))
                  : String.valueOf(String.valueOf(msg2))
                      .concat(
                          String.valueOf(
                              String.valueOf(
                                  String.valueOf(
                                      String.valueOf(
                                          new StringBuffer("Torch (")
                                              .append(hp.packCount("Torch"))
                                              .append(")"))))));
        }
      } else if (Tools.getRegion() instanceof arHills) {
        msg =
            hp.hasTrait(Constants.HILLFOLK)
                ? String.valueOf(String.valueOf(msg2)).concat("Hill Folk")
                : String.valueOf(String.valueOf(msg2))
                    .concat(
                        String.valueOf(
                            String.valueOf(
                                String.valueOf(
                                    String.valueOf(
                                        new StringBuffer("Rope (")
                                            .append(hp.packCount("Rope"))
                                            .append(")"))))));
      } else {
        msg =
            String.valueOf(String.valueOf(msg2))
                .concat(
                    String.valueOf(
                        String.valueOf(
                            String.valueOf(
                                String.valueOf(
                                    new StringBuffer(String.valueOf(String.valueOf(hp.getWeapon())))
                                        .append(" & ")
                                        .append(hp.getArmour()))))));
      }
