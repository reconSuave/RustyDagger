...
public class ArmsTable {
  ...
  void add(String info) {
    ...
    if (it == null || !(it instanceof itArms)) {
      System.err.println(
          String.valueOf(
              String.valueOf(new StringBuffer("ArmsTable bad item = [").append(info).append("]"))));
    } else if (table.get(it.getName()) != null) {
      System.err.println(
          String.valueOf(
              String.valueOf(
                  new StringBuffer("ArmsTable duplicate key = [")
                      .append(it.getName())
                      .append("]"))));
    } else {
  ...
  public static itArms get(String key) {
    ...
    System.err.println(
        String.valueOf(
            String.valueOf(
                new StringBuffer("ArmsTable could not find key=[").append(key).append("]"))));
    return null;
  }
  ...
  public static boolean find(String key) {
    ...
    System.err.println(
        String.valueOf(
            String.valueOf(
                new StringBuffer("ArmsTable could not find item=[").append(key).append("]"))));
    return false;
  }
