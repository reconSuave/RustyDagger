...
public class arqMingle extends arNotice {
  ...
  public static final String mingleMsg =
      "$TB$You engange $lordname$ in conversation. $interests$$CR$";
  ...
  static String prepareText() {
    ...
    MadLib msg =
        new MadLib(
            mingleMsg.concat(
                String.valueOf(
                    String.valueOf(mingleText[Tools.fourTest(skill, level * MINGLERISK)]))));
