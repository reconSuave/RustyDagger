      ...
      String.valueOf(
          String.valueOf(
              new StringBuffer(
                  ...
                  .append(someone[Tools.roll(someone.length)])
                  .append(" mingled in the crowd, but you can't be entirely sure.\n")
                  .append("\tA carpet is rolled back, revealing a blood soaked ")
                  .append("pentagram!  A goat is brought forward!! You are handed ")
                  .append("a condom!!!\n")
                  .append("\tThen they take your money and give you a guild pass. ")
                  .append("While everyone gets drunk, you are sworn to secrecy. ")
                  .append("You must never reveal the secret sacred rituals of the ")
                  .append("Free Adventurers Guild.\n\t\t\t\t\tBottoms Up!!!\n")));
  static final String fightMsg = "\tYou enter a rigorous regimen. Each morning you are beaten senseless by a dozen guild members. You are only fed meat and sugar. You must stand motionless beneath a waterfall for eight hours. You are dragged over rocks by wild horses. You must run uphill with buckets of water at arms length.\n\tOne morning you snap. In a berzerker rage, you beat your trainers bloody.\n\t\t\tYour Training is Complete\n\n<<< You Have Gained in Combat Skill >>>\n\n*** You Have Grown Dumber  -2 Wits ***\n\n*** You Have Grown Sadder  -2 Charm ***\n";
  static final String magicMsg = " \tYou enter the guild library where you are inducted into the secrets of the mystic arts. \tThe truth is simple. You must bribe demons and faeries with gemstones. The hardest part of your training is memorizing the names and desires of these thousand and eight furtive spirits.\n\tEventually you manage to recite about a hundred of these names without summoning anything really powerful and vindictive.\n\t\t\tYour Training is Complete\n\n<<< You Have Gained in Magery Skill >>>\n\n*** You Have Grown Weaker  -2 Guts ***\n\n*** You Have Grown Sadder  -2 Charm ***\n";
  static final String thiefMsg = "\tYou are taken into a hidden alcove where five shifty members teach you the secrets of \'trading\'.\n\tFirst you are taught the arts of subterfuge and misdirection. Second you learn about sleight of hand and concealment.  Third you are given detailed instruction regarding running and hiding. Fourth you are shown the value of attacking from the shadows. Finally you learn that suckers must never be given an even break.\n\t\t\tYour Training is Complete\n\n<<< You Have Gained in Trading Skill >>>\n\n*** You Have Grown Weaker  -2 Guts ***\n\n*** You Have Grown Dumber  -2 Wits ***\n";
  ...
  public arGuild(Screen from) {
    super(
        ...
        "The Free Adventurers Guild"
            .concat(
                String.valueOf(
                    String.valueOf(Screen.getQuests() < 5 ? " - Closed For Rituals" : ""))));
  }
  ...
  public void updateTools(itHero h) {
    ...
    for (int i3 = 0; i3 < this.tools.length; i3++) {
      if (i3 == 0) {
        ...
        msg =
            String.valueOf(String.valueOf(text[i3]))
                .concat(
                    String.valueOf(
                        String.valueOf(
                            guild == 0
                                ? " Free"
                                : " $".concat(String.valueOf(String.valueOf(this.cost[i3]))))));
      }
