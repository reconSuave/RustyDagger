...
public class arQueen extends Indoors {
  ...
  public static final String investMsg =
  ...
  public static final String[][] investJobs = {
    new String[] {"the Oat Harvest", "the Wheat Harvest", "the Barley Harvest"},
    new String[] {"the Grape Harvest", "Hog Futures", "Wool Futures"},
    new String[] {"a Cargo of Wine", "a Cargo of Beer", "a Cargo of Dried Meat"},
    new String[] {"the Leather Works", "the Iron Works", "the Lumber Yard"},
    new String[] {"a Flower Shop", "a Pastry Shop", "a Fine Theatre"},
    new String[] {"a Cargo of Weapons", "a Cargo of Farm Tools", "A Cargo of Glassware"},
    new String[] {"a Cargo of Artwork", "a Cargo of Fine Wines", "a Cargo of Jewelry"},
    new String[] {
      "bribes to the Chief Counselor", "bribes to the Guard Captain", "bribes to the Guild Master"
    }
  };
  public static final String[] investRisk = {
    "marginal", "minimal", "small", "moderate", "large", "substantial", "massive", "incredible"
  };
  public static final String[] officialTitle = {
    "Captain ",
    "Doctor ",
    "Mayor ",
    "Abbot ",
  ...
  public static final String[] petitionText = {
  ...
  public String getGreeting() {
    ...
    return msg == null
        ? String.valueOf(
            String.valueOf(new StringBuffer("Have you seen ").append(Screen.getBest()).append("?")))
        : msg;
  }
  ...
  public void localPaint(Graphics g) {
    ...
    if (rank < 9) {
      g.drawString(
          String.valueOf(
              String.valueOf(
                  new StringBuffer(String.valueOf(String.valueOf(Constants.rankName[sex][rank])))
                      .append(" to ")
                      .append(Constants.rankName[sex][rank + 1]))),
          180,
          190);
    }
  }
