...
public class arBattle extends Screen implements GearTypes {
    ...
    if (heroFirst) {
      msg =
          String.valueOf(String.valueOf(""))
              .concat(
                  String.valueOf(String.valueOf(agentAct(hero, mob, hguts, hhit, hspeed, mspeed))));
      if (!this.killStop) {
        msg =
            String.valueOf(String.valueOf(msg))
                .concat(
                    String.valueOf(
                        String.valueOf(agentAct(mob, hero, mguts, mhit, mspeed, hspeed))));
      }
    } else {
      msg =
          String.valueOf(String.valueOf(""))
              .concat(
                  String.valueOf(String.valueOf(agentAct(mob, hero, mguts, mhit, mspeed, hspeed))));
      if (!this.killStop) {
        msg =
            String.valueOf(String.valueOf(msg))
                .concat(
                    String.valueOf(
                        String.valueOf(agentAct(hero, mob, hguts, hhit, hspeed, mspeed))));
      }
    }
    return msg;
  }
            ...
            String.valueOf(
                String.valueOf(
                        String.valueOf(
                            String.valueOf(
                                    String.valueOf(
                                        act.isMatch(Constants.ATTACK)
                                            ? String.valueOf(String.valueOf(msg))
                                                .concat(
                                                    String.valueOf(String.valueOf(this.power[hit])))
                                            : String.valueOf(String.valueOf(msg))
                                                .concat(
                                                    String.valueOf(String.valueOf(act.getName())))))
                                .concat(
                                    String.valueOf(
                                        String.valueOf(
                                            String.valueOf(
                                                String.valueOf(
                                                    new StringBuffer("\n    ---")
                                                        .append(df.getName())
                                                        .append(" ")
                                                        .append(this.effect[stk]))))))))
                    .concat(String.valueOf(String.valueOf(spellEffects(at, df))))))
        .concat("\n");
  }
              ...
              .concat(
                  String.valueOf(
                      String.valueOf(
                          String.valueOf(
                              String.valueOf(
                                  new StringBuffer(ABUF)
                                      .append(df.getName())
                                      .append(" is Mesmerized!\n"))))));
      at.setState("Control");
      this.killStop = true;
    } else {
      msg =
  ...
  String combatEvents(String msg) {
                          ...
                          String.valueOf(
                              String.valueOf(
                                  new StringBuffer("\tThe ")
                                      ...
                                      .append(" gains energy by eating ")
                                      .append(num)
                                      .append(" ")
                                      .append(GearTypes.GINSENG)
                                      .append("\n"))))));
    }
                      ...
                      String.valueOf(
                          String.valueOf(
                              String.valueOf(
                                  new StringBuffer("\tThe ")
                                      .append(this.mob.getName())
                                      .append(" washes dust from its ")
                                      .append("eyes by using ")
                                      .append(GearTypes.SELTZER)
                                      .append("\n"))))));
    }
    ...
    if (ma.isMatch(Constants.GOAT)) {
      msg =
          String.valueOf(String.valueOf(msg))
              .concat(String.valueOf(String.valueOf(this.mob.goatSkill())));
    }
    if (ma.isMatch(Constants.WORM)) {
      msg =
          String.valueOf(String.valueOf(msg))
              .concat(String.valueOf(String.valueOf(this.mob.wormSkill())));
    }
    return msg;
  }
}
