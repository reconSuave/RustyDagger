...
public class arDetail extends arNotice {
  ...
  String detail(Item it) {
    return it instanceof itArms
        ? armsDetail((itArms) it)
        : it instanceof itCount
            ? countDetail((itCount) it)
            : it instanceof itNote ? noteDetail((itNote) it) : "No Information";
  }
        ...
        msg =
            String.valueOf(String.valueOf(msg))
                .concat(
                    String.valueOf(
                        String.valueOf(
                            " ".concat(String.valueOf(String.valueOf(ArmsTrait.traitLabel[ix]))))));
        none = false;
      }
    }
    if (none) {
                ...
                .concat(
                    String.valueOf(
                        String.valueOf(
                            "\n\t\t"
                                .concat(
                                    String.valueOf(String.valueOf(ArmsTrait.traitLabel[ix2]))))));
          ...
          msg3 =
              String.valueOf(String.valueOf(msg3))
                  .concat(
                      String.valueOf(
                          String.valueOf(
                              enchantStrength(a.getPower(), a.getCount(ArmsTrait.ENCHANT)))));
        }
        none2 = false;
      }
    }
