    ...
    if (fullAttack() != 0) {
      msg2 =
          String.valueOf(String.valueOf(msg2))
              .concat(
                  String.valueOf(
                      String.valueOf(String.valueOf(String.valueOf(fullAttack())).concat("a"))));
    }
    if (fullDefend() > 0) {
      msg2 = String.valueOf(String.valueOf(msg2)).concat("+");
    }
    if (fullDefend() != 0) {
      msg2 =
          String.valueOf(String.valueOf(msg2))
              .concat(
                  String.valueOf(
                      String.valueOf(String.valueOf(String.valueOf(fullDefend())).concat("d"))));
    }
    if (fullSkill() > 0) {
      msg2 = String.valueOf(String.valueOf(msg2)).concat("+");
    }
    if (fullSkill() != 0) {
      msg2 =
          String.valueOf(String.valueOf(msg2))
              .concat(
                  String.valueOf(
                      String.valueOf(String.valueOf(String.valueOf(fullSkill())).concat("s"))));
    }
