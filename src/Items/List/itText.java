...
public class itText extends itList {
    ...
    public String toString(int depth) {
        return String.valueOf(String.valueOf(new StringBuffer(String.valueOf(String.valueOf(toStringHead(depth)))).append("|").append(getText()).append("}")));
    }
    ...
    public String toString() {
        return String.valueOf(String.valueOf(new StringBuffer("{itText|").append(getName()).append("|").append(getText())));
    }
    ...
    void parseText() {
        ...
        for (int ix = 0; ix < getCount(); ix++) {
            Item list = select(ix);
            if ((list instanceof itList) && (pick = ((itList) list).select(Tools.roll(list.getCount()))) != null) {
