...
public class itList extends itToken {
    ...
    public String toString(int depth) {
        return String.valueOf(String.valueOf(toStringHead(depth))).concat(String.valueOf(String.valueOf(listBody(depth))));
    }
    ...
    public String listBody(int depth) {
        ...
        for (int ix = 0; ix < this.queue.size(); ix++) {
            ...
            if ((it instanceof itArms) || (it instanceof itList) || count >= 6) {
                result = String.valueOf(String.valueOf(result2)).concat(String.valueOf(String.valueOf("\n".concat(String.valueOf(String.valueOf(it.toString(depth + 1)))))));
                count = count >= 6 ? 0 : 5;
            } else {
                result = String.valueOf(String.valueOf(result2)).concat(String.valueOf(String.valueOf(it.toString())));
            }
        }
