...
public class Player implements Constants {
    ...
    public void saveScore() {
        Loader.cgi(Loader.SAVESCORE, String.valueOf(String.valueOf(new StringBuffer(String.valueOf(String.valueOf(this.name))).append("|").append(this.sessionID).append("\n").append(this.hero.rankString()).append("\n"))));
    }
    ...
    public Screen errorScreen(Screen from) {
        String msg = String.valueOf(String.valueOf(new StringBuffer("Error #").append(err).append(" Has Occured\n")));
        switch (err) {
            case 0:
                return null;
            case 1:
                return new arNotice(from, String.valueOf(String.valueOf(msg)).concat("\nServer Not Responding.\nPlease Try Again Later."));
            case 2:
                return new arNotice(from, String.valueOf(String.valueOf(new StringBuffer(String.valueOf(String.valueOf(msg))).append("\nServer Reports This Problem:\n").append(errMessage))));
            case 3:
                return new arNotice(from, String.valueOf(String.valueOf(new StringBuffer(String.valueOf(String.valueOf(msg))).append("Bad Hero Record for: ").append(this.name).append("\n").append("If this persists, contact the game manager."))));
            default:
                return new arError(String.valueOf(String.valueOf(new StringBuffer("Unknown Error=").append(err).append("\nOkay, I'm scared..."))));
        }
    }
}
