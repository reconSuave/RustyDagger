...
public class MadLib {
    ...
    public MadLib(String msg) {
        this.gender = new String[][]{new String[]{"$HE$", "he", "she"}, new String[]{"$HIM$", "him", "her"}, new String[]{"$HIS$", "his", "her"}, new String[]{"$MAN$", "man", "woman"}, new String[]{"$BOY$", "boy", "girl"}};
    ...
    public void append(String val) {
        ...
        this.text = String.valueOf(String.valueOf(this.text)).concat(String.valueOf(String.valueOf(val)));
    }
    ...
    String update(String from) {
        ...
        while (true) {
            ...
            result = String.valueOf(String.valueOf(result)).concat(String.valueOf(String.valueOf(from.substring(ix, dx))));
            ix = dx;
            ...
            result = String.valueOf(String.valueOf(result)).concat(String.valueOf(String.valueOf(put == null ? sub : update(put))));
        }
        return String.valueOf(String.valueOf(result)).concat(String.valueOf(String.valueOf(from.substring(ix))));
    }
}
