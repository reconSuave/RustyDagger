  ...
  Screen sendPackage() {
    ...
    if (dest.length() < 4 || dest.length() > 15) {
      return new arNotice(
          ...
          String.valueOf(
              String.valueOf(
                  new StringBuffer("\tThe name you have selected is malformed:\n<")
                      .append(dest)
                      .append(">\n\n")
                      .append("\tHero names must be at least 4 letters and no ")
                      .append("more than 15 letters\n"))));
    }
