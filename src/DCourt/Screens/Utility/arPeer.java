...
public class arPeer extends arNotice {
    ...
    static final String noDescription = "$title$ $name$ = No Description\n\n\tGuts: $guts$\tWits: $wits$\tCharm: $charm$\nWeapon: $weapon$\nArmor: $armor$";
    static final String describe0 = "\t$title$ $name$ $clanmsg$ is a $build$ $race$ with $hair$ hair, $eyes$ eyes, and $skin$ skin. $dress$ $behave$ $intro$ the odd trait of $marks$. Rumor has it that $HE$ is a $sign$. \n\tAs you peer into the gem you espy";
