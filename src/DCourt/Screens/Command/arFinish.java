...
public class arFinish extends Screen implements Constants {
  ...
  public void localPaint(Graphics g) {
    ...
    g.drawString(
        String.valueOf(
            String.valueOf(
                new StringBuffer("Statistics for ")
                    .append(this.hero.getTitle())
                    .append(this.hero.getName()))),
        10,
        195);
    ...
    if (level() > 0) {
      g.drawString(
          "Power burns within you: "
              .concat(String.valueOf(String.valueOf(value(Constants.LEVEL, level())))),
          20,
          220);
    } else {
      g.drawString(
          "Difficult lessons learned: "
              .concat(String.valueOf(String.valueOf(value(Constants.EXP, exp())))),
          20,
          220);
    }
    g.drawString(
        String.valueOf(
            String.valueOf(
                new StringBuffer("Your legend has ")
                    .append(fame() < 0 ? "declined" : "grown")
                    .append(": ")
                    .append(value(Constants.FAME, fame())))),
        20,
        245);
    g.drawString(
        String.valueOf(
            String.valueOf(
                new StringBuffer("Wealth accumulates ")
                    .append(money() < 0 ? "slowly" : "rapidly")
                    .append(": ")
                    .append(value("Marks", money())))),
        20,
        270);
  }
  ...
  String value(String what, int val) {
    return val < 0
        ? String.valueOf(
            String.valueOf(
                new StringBuffer(String.valueOf(String.valueOf(val))).append(" ").append(what)))
        : String.valueOf(
            String.valueOf(new StringBuffer("+").append(val).append(" ").append(what)));
  }
