...
public class arCreate extends Screen {
    static final Rectangle[] sink = {new Rectangle(40, 80, 65, 40), new Rectangle(160, 80, 65, 40), new Rectangle(280, 80, 65, 40), new Rectangle(245, 160, 100, 40), new Rectangle(40, 240, 65, 40)};
    static final String[] text = {Constants.GUTS, Constants.WITS, Constants.CHARM, "Money(1p=$25)", "Build Points"};
    ...
    int getBuild() {
        int build = (((20 - (this.guts.getCount() - 4)) - (this.wits.getCount() - 4)) - (this.charm.getCount() - 4)) - (this.money.getCount() - 1);
    ...
    public void localPaint(Graphics g) {
        ...
        DrawTools.center(g, String.valueOf(String.valueOf(isNoble() ? "Knight " : "")).concat(String.valueOf(String.valueOf(this.who.getName()))), 200, 35);
    ...
    public void createTools() {
        ...
        for (int i3 = 0; i3 < this.traits.length; i3++) {
            this.traits[i3] = new Checkbox(String.valueOf(String.valueOf(new StringBuffer(String.valueOf(String.valueOf(traitStr[i3]))).append(" ").append(traitCost[i3]).append("p"))));
