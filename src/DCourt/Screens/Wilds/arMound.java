...
public class arMound extends WildsScreen {
  static final int FINDFIELDS = 50;
  static final int FINDVORTEX = 100;
  static final int[][] weight = {
    new int[] {5, 7, 3, 8, 4}, new int[] {5, 5, 5, 7, 3}, new int[] {5, 5, 5, 4, 2}
  };
  static final String[][] beasts = {
    new String[] {"Worm", "Thief", "Mage", "Gang", "Rager"},
    new String[] {"Worm", "Thief", "Mage", "Guard", "Vault"},
    new String[] {"Worm", "Thief", "Mage", "Queen", "Champ"}
  };
                    ...
                    String.valueOf(
                        String.valueOf(
                            new StringBuffer(
                                ...
                                .append(fields[Tools.roll(fields.length)])
