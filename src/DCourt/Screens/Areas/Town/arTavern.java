...
public class arTavern extends Indoors implements Rumors {
    Button[] tools;
    String[] monger = {"One old woman tells you:", "A spirited forester tells you:", "An old drunken soldier tells you:", "Silas Keeper whispers to you:", "A beligerent fish monger prods you:", "A sly bard sing to you:", "Kara the barmaid sidles up to you:"};
    static String[] greeting = {null, "This job is great", "I love to drink", "You're my best friend", "I'm so happy", "Hixxup! Excuse me", "Burrrp - Ahhhhh", "*Sniff* *Sniff* <Gulp>", "Beer is my friend", "Huh? You say something?", "I'm kinda sleepy"};
    static int[] cost = {1, 5, 25, 100, 1};
    static String[] text = {"Buy a Drink", "Sleep on Floor", "Rent a Room", "Rent a Suite", "Storage"};
    ...
    public void createTools() {
        ...
        for (int i2 = 0; i2 < this.tools.length; i2++) {
            String msg = text[i2];
            if (cost[i2] > 0) {
                msg = String.valueOf(String.valueOf(new StringBuffer("$").append(cost[i2]).append(" ").append(msg)));
            }
    ...
    Screen rumors() {
        ...
        switch (val) {
            case 0:
                msg = String.valueOf(String.valueOf(GameStrings.GOSSIP)).concat(String.valueOf(String.valueOf(String.valueOf(String.valueOf(new StringBuffer("\n\tSomeone slips you a mickey. You awake with a headache in the dark and stinking alley.\n\n*** You Have Missed One Quest ***\n\n*** ").append(h.getMoney()).append(" Marks Lost ***\n"))))));
