...
public class arDwfSmith extends Smith {
    static String[] greeting = {null, "What the hell you want?", "Think as you're tough?", "Sod off ye bugger!", "What now!", "Well, piss on me", "Fargin' hell!", "Acch! What is it?", "Shades! Go away!", "This is me finest work", "A dandy bit this is", "Here's a pretty piece", "This is art, laddy", "Mithril is crap!", "I spit on Mithril", "Elf Bows? Bah!", "Gak! I hate Elf Bows!", "REPAIR!? Smeg off!", "FIX IT!? Yure Nuts!", "POLISH!? I'm no serf!"};
    static final String[] stock = {"Steel Sword", "Bill Hook", "Sword Breaker", "Shakrum", "Recurve Bow", "Half Plate", "Full Plate", "Steel Buckler", "Roman Helm", "Doc Martins", "Mercury Sandals"};
