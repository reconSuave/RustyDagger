...
public class arHealer extends Screen {
    Button[] tools;
    int[] cost;
    static final String[] text = {"Minor Healing", "Half Healing", "Full Healing", "Tithe", "Cure Disease"};
    static final String[] greeting = {null, "How may I aid thee?", "Please let me help", "Care for a massage?", "Let me heal thy aches", "Thou art distressed", "Thou art disturbed", "Share with the poor", "Can you spare some marks?", "Tithe for thy soul", "Alms for the poor?"};
    ...
    public void createTools() {
        greeting[0] = "Be brave like ".concat(String.valueOf(String.valueOf(Tools.getPlayer().getBest())));
    ...
    public void updateTools() {
        ...
        for (int i = 0; i < this.tools.length; i++) {
            ...
            this.tools[i].setLabel(String.valueOf(String.valueOf(new StringBuffer(String.valueOf(String.valueOf(text[i]))).append(" $").append(this.cost[i]))));
        }
    }
}
