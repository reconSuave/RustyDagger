...
public class arGoblin extends Shop implements GRumors {
    ...
    Checkbox bar;
    Checkbox shop;
    static String[] greeting = {null, "Sorry, I sneezded on it", "Zat's funny! tee-hee-hee!", "Need some shirtzez?", "I can loanzez money...", "You need zomething?", "I price thingzez nice", "Insuranze for your woezez?", "Whatz your problemzez?"};
    static int[] cost = {0, 10, 250};
    static String[] text = {"Sleep on Floor", "Buy a Drink", "Rent Smelly Cot"};
    static final String[] stock = {"Gobble Inn Postcard", "Gobble Inn T-Shirt", "Identify Scroll", GearTypes.SALVE, GearTypes.SELTZER, "Map to Warrens", GearTypes.INSURANCE, "Map to Treasury"};
    static final String[] monger = {"An old goblin witch tells you:", "A frothing berzerker screams:", "A sly pickpocket sidles up to you:", "Smidgeon Crumb grunts at you:", "A beligerent worm herder prods you:", "A goblin mage deigns to inform you:", "Slouch the barmaid mumbles to you:"};
    ...
    public String getGreeting() {
        ...
        return msg == null ? String.valueOf(String.valueOf(Tools.getBest())).concat(" aint nuzzin") : msg;
    }
    ...
    public void createTools() {
        ...
        for (int i2 = 0; i2 < this.tools.length; i2++) {
            String msg = text[i2];
            if (cost[i2] > 0) {
                msg = String.valueOf(String.valueOf(msg)).concat(String.valueOf(String.valueOf(" $".concat(String.valueOf(String.valueOf(cost[i2]))))));
            }
    ...
    Screen rumors() {
        ...
        switch (Tools.roll(Screen.getCharm())) {
            ...
            case 8:
            case 9:
                msg = String.valueOf(String.valueOf(GameStrings.GOSSIP)).concat("\tNoone seems interested in you...\n");
                break;
            default:
                msg = String.valueOf(String.valueOf(String.valueOf(String.valueOf(String.valueOf(String.valueOf(GameStrings.GOSSIP)).concat(String.valueOf(String.valueOf(String.valueOf(String.valueOf(new StringBuffer("\n\t").append(Tools.select(monger)).append("\n")))))))).concat(String.valueOf(String.valueOf(String.valueOf(String.valueOf(new StringBuffer("\n\t").append(Tools.select(GRumors.grumors)).append("\n")))))))).concat(String.valueOf(String.valueOf(Screen.getHero().gainCharm(2))));
                break;
        }
