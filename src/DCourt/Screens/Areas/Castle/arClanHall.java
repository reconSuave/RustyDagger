...
public class arClanHall extends Indoors implements Constants {
  ...
  static final int JOIN_COSTS = 1000;
  static final int QUIT_QUESTS = 5;
  static final int QUIT_COSTS = 5000;
  static final int DISBAND_QUESTS = 15;
  static final int DISBAND_COSTS = 50000;
  static final int CREATE_QUESTS = 75;
  static final int CREATE_COSTS = 250000;
  ...
  static final String petitionMsg =
  ...
  static final String denyHead = "You draft the following missive:\n\n";
  static final String denyMsg =
  ...
  static final String disbandMsg =
  ...
  public String getGreeting() {
    ...
    return msg == null
        ? String.valueOf(String.valueOf(Tools.getBest())).concat(" was just here")
        : msg;
  }
  ...
  public void localPaint(Graphics g) {
    ...
    g.drawString(
        String.valueOf(
            String.valueOf(new StringBuffer(">>> ").append(h.getTitle()).append(h.getName()))),
        180,
        60);
    g.setFont(getFont());
    ...
    if (act == this.member) {
      ...
      if (this.petition == null) {
        ...
        g.drawString(
            "Petition from ".concat(String.valueOf(String.valueOf(this.petition.getValue()))),
            180,
            170);
      }
    }
  ...
  void updateTools() {
    ...
    if (act != null) {
      if (act == this.join && this.clanStatus == 1) {
        ...
        this.enact.enable(
            this.confirm.getState() && h.getQuests() >= 1 && h.getMoney() >= JOIN_COSTS);
      ...
      if (act == this.quit) {
        if (this.heroStatus == 3) {
          ...
          this.enact.enable(
              this.confirm.getState() && h.getQuests() >= 15 && h.getMoney() >= DISBAND_COSTS);
          this.enact.show(true);
          this.confirm.show(true);
          ...
          this.enact.enable(
              this.confirm.getState() && h.getQuests() >= 5 && h.getMoney() >= QUIT_COSTS);
          this.enact.show(true);
          this.confirm.show(true);
        }
      }
      if (act == this.create && this.clanStatus == 2) {
        ...
        this.enact.enable(
            this.confirm.getState()
                && h.getQuests() >= CREATE_QUESTS
                && h.getMoney() >= CREATE_COSTS);
        this.enact.show(true);
        this.confirm.show(true);
      }
      if (this.heroStatus != 3) {
  ...
  void findClanInfo(String clan) {
    ...
    if (this.current != null
        ...
        && !Constants.NONE.equalsIgnoreCase(this.current)) {
      repaint();
  ...
  Screen quitClan() {
    ...
    String.valueOf(
            String.valueOf(
                String.valueOf(
                        String.valueOf(
                            String.valueOf(String.valueOf(leaveClan))
                                .concat(String.valueOf(String.valueOf(h.gainExp(h.getLevel()))))))
                    .concat(String.valueOf(String.valueOf(h.gainWits(25))))))
        .concat(String.valueOf(String.valueOf(h.gainCharm(25))));
    ...
    return new arNotice(
        ...
        String.valueOf(
                String.valueOf(
                    String.valueOf(
                            String.valueOf(
                                String.valueOf(String.valueOf(sent.getText()))
                                    .concat(
                                        String.valueOf(
                                            String.valueOf(
                                                h.gainExp(h.getLevel() * h.getLevel() * 10))))))
                        .concat(String.valueOf(String.valueOf(h.gainWits(500))))))
            .concat(String.valueOf(String.valueOf(h.gainCharm(500)))));
  }
                                ...
                                String.valueOf(String.valueOf(sent.getText()))
                                    .concat(
                                        String.valueOf(
                                            String.valueOf(
                                                h.gainExp((h.getLevel() * h.getLevel()) + 10))))))
                        .concat(String.valueOf(String.valueOf(h.gainWits(100))))))
            .concat(String.valueOf(String.valueOf(h.gainCharm(100)))));
  }
    ...
    String result =
        arPackage.send(
            String.valueOf(String.valueOf(hero.getTitle()))
                .concat(String.valueOf(String.valueOf(hero.getName()))),
