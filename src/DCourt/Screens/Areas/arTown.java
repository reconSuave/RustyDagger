...
public class arTown extends Screen {
    ...
    Screen enterCastle() {
        ...
        return (h.getSocial() > 0 || h.packCount("Castle Permit") > 0) ? new arCastle() : h.getQuests() < 1 ? new arNotice(this, WildsScreen.TOO_TIRED) : new arQuest(this, new arCastle(), 3, "Castle Gate", Screen.findBeast("Town:Guard"));
    }
}
