...
public class arMagicShop extends Trade implements GearTypes {
    static String[] greeting = {null, "Greetings Master", "You Wish is My Command", "How May I Serve Thee?", "Do Not Anger Me", "Seek and Ye Shall Find", "Try Blinding Trolls", "Seltzer Cleans Dust", "Never Ask A Girls Age"};
    static final String[] stock = {"Identify Scroll", "Glow Scroll", GearTypes.SALVE, GearTypes.SELTZER, GearTypes.PANIC_DUST, "Gold Apple", GearTypes.BLIND_DUST, "Bless Scroll", "Luck Scroll", "Enchant Scroll", "Flame Scroll", "Faceless Potion"};
    ...
    public String getGreeting() {
        ...
        return msg == null ? String.valueOf(String.valueOf(Tools.getBest())).concat(" Is Dreeeamy*") : msg;
    }
