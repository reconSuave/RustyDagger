...
public class arqBoast extends arNotice {
    ...
    // public static final String boastMsg = boastMsg;
    public static final String[] boastText = {"$TB$Your narrative is going well, when quite by accident you $accident$$CR$$TB$You apologize profusely, but the guardsmen grab you by the collar, take half your purse for damages and eject you from the premises.$CR$", "$TB$$lordname$'s frown grows deeper and deeper as you blather continuously about the inummerable goblins, rodents, and boars you have slain in your day.$CR$$TB$Finally, $HE$ interrupts you, declares you a bore and a liar and stomps away indignantly for having wasted $his$ time.$CR$", "$TB$The $lordrank$ bears an amused smile throughout your discourse.  When your tale is concluded, $HE$ thanks you for the opportunity to wax nostalgic and dream about $HIS$ own halcyon days of youth.$CR$", "$TB$The $lordrank$ listens with fascination for the better part of an hour.  $HE$ is favorably impressed by your courage and heroism and agrees to take up your case with the queen.$CR$", "$TB$The $lordrank$ becomes the core of an admiring knot of listeners.  When you finish they all applaud.$CR$$TB$The $lordrank$ shakes your hand and thanks you heartily for such a terrifically inspiring tale of braggadocio and derring-do.  $HE$ further declares you to be a credit and inspiration to the entire court.$CR$"};
    public static final String[] accidents = {"smash an antique burial urn.", "step on the dinner platter.", "slip and fall into the fireplace.", "hurl a drumstick into the Queen's lap.", "kick the Queen's favorite wolf-hound.", "skid and rip your trews wide open.", "throw wine on the Queen's portrait.", "refer to the Queen as 'a bit of rumpy-pumpy'.", "swing on the chandelier, carrying it and you into a drunken group of visiting dignitaries who proceed to pummel you senseless with their oddly shaped walking sticks."};
