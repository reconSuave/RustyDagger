...
public class GearTable implements GearTypes {
    ...
    public static boolean find(String key) {
        ...
        System.err.println(String.valueOf(String.valueOf(new StringBuffer("GearTable could not find item=[").append(key).append("]"))));
        return false;
    }
    ...
    void add(GearRecord rec) {
        if (table.get(rec.getName()) != null) {
            System.err.println(String.valueOf(String.valueOf(new StringBuffer("GearTable duplicate key=[").append(rec.getName()).append("]"))));
        } else {
