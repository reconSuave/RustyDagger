...
public class MonsterTable implements Quests, VQuests {
    ...
    public static itMonster find(String key) {
        ...
        System.err.println(String.valueOf(String.valueOf(new StringBuffer("MonsterTable could not find key=[").append(key).append("]"))));
        return null;
    }
    ...
    void add(String key, String info) {
        ...
        if (it == null || !(it instanceof itMonster)) {
            System.err.println(String.valueOf(String.valueOf(new StringBuffer("MonsterTable bad item = [").append(info).append("]"))));
        } else if (table.get(key) != null) {
            System.err.println(String.valueOf(String.valueOf(new StringBuffer("MonsterTable duplicate key=[").append(key).append("]"))));
        } else {
