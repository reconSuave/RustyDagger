...
public class Tools {
    ...
    static void fixJvmVersion() {
        ...
        System.out.println(String.valueOf(String.valueOf(new StringBuffer("JVM version ").append(vers).append("  game=[").append(jvmVersion).append("]"))));
    }
    ...
    public static Image loadImage(String path) {
        ...
        if (!papa.isInBrowser()) {
            tmp = papa.getToolkit().getImage(String.valueOf(String.valueOf(new StringBuffer(String.valueOf(String.valueOf(artpath))).append("/").append(path))));
        } else {
            try {
